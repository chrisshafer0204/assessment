...
@Composable
fun ProgressComponent(isLoading: Boolean) {
    ...
    Column(
        ...
        modifier = if (isLoading) Modifier.fillMaxWidth().fillMaxHeight()
        else Modifier.width(0.dp).height(0.dp),
        ...
        CircularProgressIndicator(
            ...
            // to our progress bar.
            color = colorResource(id = onesky.assessment.R.color.purple_200),
